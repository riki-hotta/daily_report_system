...
public class EmployeeConverter {
    ...
    public static Employee toModel(EmployeeView ev) {
        ...
        return new Employee(
                ...
                ev.getBossFlag() == null
                        ? null
                        : ev.getBossFlag() == AttributeConst.BOSS_SECTION.getIntegerValue()
                                ? JpaConst.BOSS_SECTION
                                : JpaConst.BOSS_GENERAL);
    }
    ...
    public static EmployeeView toView(Employee e) {
        ...
        return new EmployeeView(
                ...
                e.getBossFlag() == null
                        ? null
                        : e.getBossFlag() == JpaConst.BOSS_SECTION
                                ? AttributeConst.BOSS_SECTION.getIntegerValue()
                                : AttributeConst.BOSS_GENERAL.getIntegerValue());
    }
