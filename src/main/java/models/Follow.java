...
@NamedQueries({
    @NamedQuery(
            name = JpaConst.Q_FOLLOWED_GET_ALL_MINE,
            query = JpaConst.Q_FOLLOWED_GET_ALL_MINE_DEF),
    @NamedQuery(
            name = JpaConst.Q_FOLLOWED_COUNT_ALL_MINE,
            query = JpaConst.Q_FOLLOWED_COUNT_ALL_MINE_DEF),
    @NamedQuery(
            name = JpaConst.Q_FOLLOWED_COUNT_REP_AND_EMP,
            query = JpaConst.Q_FOLLOWED_COUNT_REP_AND_EMP_DEF)
})
